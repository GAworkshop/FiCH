...
public class MyWatchFace extends CanvasWatchFaceService{
    ...
    private class Engine extends CanvasWatchFaceService.Engine implements
        ...
        public void onConnected(@Nullable Bundle bundle) {
            Toast.makeText(MyWatchFace.this, "Connected", Toast.LENGTH_LONG).show();
        }

        @Override
        public void onConnectionSuspended(int i) {
            Toast.makeText(MyWatchFace.this,"Suspended",Toast.LENGTH_LONG).show();
        }
        ...
        public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
            Toast.makeText(MyWatchFace.this, "Connection Failed", Toast.LENGTH_LONG).show();
        }
